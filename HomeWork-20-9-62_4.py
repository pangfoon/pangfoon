#4.โปรแกรมเปรียบเทียบตัวเลขจำนวนเต็มที่รับเข้ามาทางคีย์บอร์ด จำนวน 3 ตัว แล้วแสดงผลว่า ตัวเลขตัวใดมีค่ามากที่สุด และถ้าตัวเลขมีค่าเท่ากัน ให้แสดงว่า "พบตัวเลขมีค่าเท่ากัน" ให้จบโปรแกรม
